...
import com.nuitdinfo.sltviewer.Light
import com.nuitdinfo.sltviewer.R
...
class Floor : ArrayModel() {
    ...
    fun setOffsetY(y: Float) {
        Matrix.translateM(modelMatrix, 0, 0.0f, y - 0.01f, 0.0f)
    }
